  ...
  return (
    ...
    >
      ...
      <Dialog open={showPromo} onOpenChange={setShowPromo}>
        <DialogContent className="dark w-[90%] sm:w-11/12 max-w-sm rounded-2xl bg-card/80 dark:bg-zinc-900/80 backdrop-blur-lg border-primary/20 text-white shadow-2xl">
            <DialogHeader>
