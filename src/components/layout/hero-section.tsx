                ...
                <section>
                    <div className="relative pt-24">
                        ...
                        <div className="mx-auto max-w-5xl px-6">
                         ...
                         <div className="relative mt-8 sm:mt-12 md:mt-20 -mr-16 sm:mr-0">
                            <div className="relative mx-auto max-w-5xl overflow-hidden rounded-2xl p-4">
                               <Image
                                    ...
                                    data-ai-hint="abstract data flow"
                                />
                            </div>
                        </div>
                    </div>
